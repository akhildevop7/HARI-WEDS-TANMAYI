    ...
    const timer = () => {
        ...
        setInterval(() => {
         let distance = Math.abs(countDownDate - (new Date()).getTime());
            ...
            document.getElementById('Hrs').innerText = Math.floor((distance % (1000 * 60 * 60 * 24)) / (1000 * 60 * 60));
            document.getElementById('min').innerText = Math.floor((distance % (1000 * 60 * 60)) / (1000 * 60));
            document.getElementById('Sec').innerText = Math.floor((distance % (1000 * 60)) / 1000);
        }, 1000);
    };
